            ...
            if (isset($_GET['page'])) {
                ...
                switch (@$page) {
                    ...
                    case 'hapus':
                        ...
                        break;
                    case 'penanganan':
                        include('proses/penanganan_pengajuan.php');
                        break;
                    case 'info':
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover table-striped" id="table1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $query = mysqli_query($koneksi, "SELECT * FROM tb_pengaduan WHERE status_pengaduan='Diproses' AND id_pengaduan!=$data[id_pengaduan]");
                                                    $no = 0;
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <form method="post">
                                                                <td>
                                                                <a href="?page=penanganan&id=<?= $data['id_pengaduan']; ?>" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="Ditindak Sekarang!"><i class="fas fa-handshake"></i></a>
                                                                ...
                                                                <a href="?page=detail&id=<?= $data['id_pengaduan']; ?>" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="bottom" title="Selengkapnya"><i class="fa fa-angle-right"></i></a>
                                                                </td>
                                                            </form>
                                                        </tr>
                                                    <?php } ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover table-striped" id="table1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $query = mysqli_query($koneksi, "SELECT * FROM tb_pengaduan WHERE status_pengaduan='Diproses'");
                                                    $no = 0;
                                                    while ($data = mysqli_fetch_assoc($query)) {
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <form method="post">
                                                                <td>
                                                                <a href="?page=penanganan&id=<?= $data['id_pengaduan']; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Ditindak Sekarang!"><i class="fas fa-handshake"></i></a>
