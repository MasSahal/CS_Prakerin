        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="akun.php">Akun Terhubung</a></li>
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="container-fluid">
                                ...
                                <button type="submit" name="ubah_akun" class="btn btn-sm btn-info"><i class="fa fa-save"></i> Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    if ($password != $password2) {
        ...
        if (strlen($password) < 10) {
            ...
            if ($ubahPw) {
                ...
                echo"<meta http-equiv='refresh' content='2;url=?page=edit_akun&id=$id'>";
            }else{
...
if (isset($_POST['ubah_akun'])) {
    ...
    $ubah_akun = mysqli_query($koneksi,"UPDATE tb_akun SET username_akun='$username',email_akun='$email',telepon_akun='$telepon',alamat_akun='$alamat' WHERE id_akun='$id'");
    
    //jika berhasil
    if ($ubah_akun) {
        echo"<script>Swal.fire('Yeayy','Berhasil Mengubah Akun !','success')</script>";
        echo"<meta http-equiv='refresh' content='2;url=akun.php'>";
    }else{
        echo"<script>Swal.fire({icon: 'error',title: 'Oops...',text: 'Gagal Mengubah Akun !'});</script>";
    }
}