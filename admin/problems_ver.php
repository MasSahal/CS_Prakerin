            ...
            if (isset($_GET['page'])) {
                ...
                switch (@$page) {
                    ...
                    case 'balas':
                        ...
                        break;
                    case 'konfirmasi':
                        include('proses/konfirmasi_pengajuan.php');
                        break;
                    case 'hapus':
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover table-striped" id="table1">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $query = mysqli_query($koneksi, "SELECT * FROM tb_pengaduan WHERE status_pengaduan='Terverifikasi' AND id_pengaduan!=$data[id_pengaduan]");
                                                    $no = 0;
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <form method="post">
                                                                <td>
                                                                    <a href="?page=konfirmasi&id=<?= $data['id_pengaduan']; ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Proses Sekarang!"><i class="fa fa-check-square"></i></a>
        ...
        <?php } elseif (!isset($_GET['page'])) { ?>
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Pengaduan - Terverifikasi</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="pengaduan_ver.php">Pengaduan - Terverifikasi</a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped" id="table1">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $query = mysqli_query($koneksi, "SELECT * FROM tb_pengaduan WHERE status_pengaduan='Terverifikasi'");
                                                $no = 0;
                                                while ($data = mysqli_fetch_assoc($query)) {
